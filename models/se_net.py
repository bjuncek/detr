...
def senet50_256(pretrained=None):
    model = Senet50_256()
    state = model.state_dict()
    if pretrained:
        state_dict = torch.load("/users/korbar/phd/personfeature/data/senet50_256.pth")
        if "state_dict" in state_dict:
            newdict = {}
            for key in state_dict["state_dict"].keys():
                newkey = key[7:]
                newdict[newkey] = state_dict["state_dict"][key]
...
class Senet50_256(nn.Module):
    ...
    def forward(self, data):
        ...
        conv2_1 = (
            conv2_1_prob_reshape.expand_as(conv2_1_1x1_increase_bn)
        ...
        conv2_2 = (
            conv2_2_prob_reshape.expand_as(conv2_2_1x1_increase_bn)
        ...
        conv2_3 = (
            conv2_3_prob_reshape.expand_as(conv2_3_1x1_increase_bn)
        ...
        conv3_1 = (
            conv3_1_prob_reshape.expand_as(conv3_1_1x1_increase_bn)
        ...
        conv3_2 = (
            conv3_2_prob_reshape.expand_as(conv3_2_1x1_increase_bn)
        ...
        conv3_3 = (
            conv3_3_prob_reshape.expand_as(conv3_3_1x1_increase_bn)
        ...
        conv3_4 = (
            conv3_4_prob_reshape.expand_as(conv3_4_1x1_increase_bn)
        ...
        conv4_1 = (
            conv4_1_prob_reshape.expand_as(conv4_1_1x1_increase_bn)
        ...
        conv4_2 = (
            conv4_2_prob_reshape.expand_as(conv4_2_1x1_increase_bn)
        ...
        conv4_3 = (
            conv4_3_prob_reshape.expand_as(conv4_3_1x1_increase_bn)
        ...
        conv4_4 = (
            conv4_4_prob_reshape.expand_as(conv4_4_1x1_increase_bn)
        ...
        conv4_5 = (
            conv4_5_prob_reshape.expand_as(conv4_5_1x1_increase_bn)
        ...
        conv4_6 = (
            conv4_6_prob_reshape.expand_as(conv4_6_1x1_increase_bn)
        ...
        conv5_1 = (
            conv5_1_prob_reshape.expand_as(conv5_1_1x1_increase_bn)
        ...
        conv5_2 = (
            conv5_2_prob_reshape.expand_as(conv5_2_1x1_increase_bn)
        ...
        conv5_3 = (
            conv5_3_prob_reshape.expand_as(conv5_3_1x1_increase_bn)
